...
export default class rateProduct extends Component {
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:4000/user/profile_recruiter_update', Update, { headers: headers })
            .then(response => {
                alert("Recruiter Details Updated!");
    ...
    componentDidMount(e) {
        ...
        axios.post('http://localhost:4000/user/profile_recruiter', body, { headers: headers })
            .then(response => {
